...
public class ResourcesHome {
	...
	public Resources merge(Resources detachedInstance) {
		...
		try {
			Resources result = (Resources) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Resources findById(int id) {
		...
		try {
			Resources instance = (Resources) sessionFactory.getCurrentSession().get("hibernate.Resources", id);
			if (instance == null) {
	...
	public List findByExample(Resources instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("hibernate.Resources")
