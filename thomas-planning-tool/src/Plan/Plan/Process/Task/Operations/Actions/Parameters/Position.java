...
public class Position extends Parameters {
	 ...
	 * @param z
	 */
	public Position(double x, double y, double z, double orientationX, double orientationY, double orientationZ,
			double orientationW, String target_fame, double vel, double acc) {
		// super();
		this.x = x;
		this.y = y;
		this.z = z;
		...
		inputX.add(Constants.POSITION_X_VALUE_ATTR);
		inputX.add(Double.toString(x));
		inputY.add(Constants.POSITION_Y_VALUE_ATTR);
		inputY.add(Double.toString(y));
		inputZ.add(Constants.POSITION_Z_VALUE_ATTR);
		inputZ.add(Double.toString(z));

		inputX.add(Constants.POSITION_X_VALUE_ATTR);
		inputX.add(Double.toString(x));

		inputOrientationX.add(Constants.POSITION_ORIENT_X_VALUE_ATTR);
		inputOrientationX.add(Double.toString(orientationX));
		inputOrientationY.add(Constants.POSITION_ORIENT_Y_VALUE_ATTR);
		inputOrientationY.add(Double.toString(orientationY));
		inputOrientationZ.add(Constants.POSITION_ORIENT_Z_VALUE_ATTR);
		inputOrientationZ.add(Double.toString(orientationZ));
		inputOrientationW.add(Constants.POSITION_ORIENT_W_VALUE_ATTR);
		inputOrientationW.add(Double.toString(orientationW));

		String inputPoseString = x + " " + y + " " + z + " " + orientationX + " " + orientationY + " " + orientationZ;

		inputPosition.add(Constants.MOVE_POSE_VALUE_ATTR);
		inputPosition.add(inputPoseString);

		inputFrame.add(Constants.MOVE_TARGET_VALUE_ATTR);
		inputFrame.add(target_fame);
		inputVel.add(Constants.MOVE_VEL_VALUE_ATTR);
		inputVel.add(Double.toString(vel));
		inputAcc.add(Constants.MOVE_ACC_VALUE_ATTR);
		inputAcc.add(Double.toString(acc));
	...
	// public Position(double x, double y, double z,double orientationW,double
	// orientationX,double orientationY, double orientationZ,String
	// target_fame,double vel,double acc) {

	public Position(double x, double y, double z, double orientationW, double orientationX, double orientationY,
			double orientationZ) {
