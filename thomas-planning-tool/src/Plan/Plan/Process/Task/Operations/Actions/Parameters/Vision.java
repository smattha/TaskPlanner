...
public class Vision extends Parameters {
	...
	public Vision(String sourceF, String targetF, String detected_part) {
		...
		VISION_DETECTED_PART.add(Constants.VISION_DETECTED_PART);
		VISION_DETECTED_PART.add(detected_part);

		VISION_SOURCE_FRAME.add(Constants.VISION_SOURCE_FRAME);
		VISION_SOURCE_FRAME.add(sourceF);
		VISION_TARGET_FRAME.add(Constants.VISION_TARGET_FRAME);
		VISION_TARGET_FRAME.add(targetF);
