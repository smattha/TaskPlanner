...
public interface ShopFloorMapInterface extends Cloneable {
    ...
    /**
     * Does not check if object can be added. Allows overlapping objects. Check
     * with
     ...
     * @return
     */
    public abstract ShopFloorMapInterface addRectangleObjectToMap(
	    RectangleObjectInterface aRectangle);

    /**
     * @param aRectangle
     * @return true if the {@link RectangleObjectInterface} can be added to the
     *         map without intersecting any other existing rectangle.
     */
    public abstract Boolean canAddRectangleObjectToMapWithoutOverlap(
	    RectangleObjectInterface aRectangle);
     ...
     */
    public abstract ShopFloorMapInterface removeRectangleObjectFromMap(
	    RectangleObjectInterface aRectangle);
    ...
    /**
     * @return the id of the object that this {@link ShopFloorMapInterface}
     *         refers to.
     */
    public abstract String getID();

    /**
     * set the id of the object that this {@link ShopFloorMapInterface} refers
     * to.
     * 
