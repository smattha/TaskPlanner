...
public class ShopFloorMapsDatabase {
	 ...
	 */
	public ShopFloorMapsDatabase putMap(ShopFloorMapInterface aNewShopFloorMapInterface) {

		String msg = ".putMap() ";
		if (aNewShopFloorMapInterface == null || aNewShopFloorMapInterface.getID() == null
				|| aNewShopFloorMapInterface.getID().isEmpty()) {
			throw new RuntimeException(msg + "aNewShopFloorMapInterface or its id should never be null.");
		}
		this.mapsDatabase.put(aNewShopFloorMapInterface.getID(), aNewShopFloorMapInterface);
		return this;
	}
}
