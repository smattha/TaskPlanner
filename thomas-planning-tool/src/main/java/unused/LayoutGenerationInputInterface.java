...
public interface LayoutGenerationInputInterface {
	 ...
	 */
	public LayoutGenerationInputInterface setResolutionDimension(Dimension aResolutionDimension);
	 ...
	 * @return
	 */
	public Collection<BasicResourceInterface> getTasksForResourves(String resourceID);
