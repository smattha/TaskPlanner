...
public class RectangleObject implements RectangleObjectInterface {
    ...
    /**
     * The current orientation of the {@link RectangleObject}. Always
     * initialized to {@link RectangleObject#ZERO_DEGREES_ORIENTATION} if not
     * set
     */
     ...
     * 
     * @param aRectangle
     *            defines the location and size of the object
     * @param id
     *            The id of the instance linked to this map
     */
	...
	return Double.compare(this.orientation,
		RectangleObject.ZERO_DEGREES_ORIENTATION) == 0;
    }
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#getRectangle
     * ()
     */
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#setRectangle
     * (java.awt.Rectangle)
     */
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#intersects
     * (lms.robopartner.datamodel.map.RectangleObjectInterface)
     */
    public boolean intersects(
	    RectangleObjectInterface anotherRectangleObjectInterface) {
	String msg = ".intersects() ";
	if (anotherRectangleObjectInterface == null
		|| anotherRectangleObjectInterface.getRectangle() == null) {
	    throw new RuntimeException(
		    msg
			    + "RectangleObjectInterface or its rectangle should never be null.");
	}

	return this.getRectangle().intersects(
		anotherRectangleObjectInterface.getRectangle());
    }
	...
	Rectangle aRectangle = new Rectangle(this.getRectangle().x,
		this.getRectangle().y, this.getRectangle().width,
		this.getRectangle().height);
	RectangleObject aRectangleObjectClone = new RectangleObject(aRectangle,
		this.getID(), this.reachability);
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#setID(java
     * .lang.String)
     */
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#setReachability
     * (java.lang.Double)
     */
	...
	this.myReachabilityRectangle = new Rectangle(this.myRectangle.getLocation(), new Dimension((int) this.reachability, (int) this.reachability));
     ...
     * 
     * @see
     * lms.robopartner.datamodel.map.RectangleObjectInterface#getReachability
     * ()
     */
    ...
    public boolean isWithinReach(
	    RectangleObjectInterface aRectangleObjectInterface) {
	String msg = ".isWithinReach() ";
	if (aRectangleObjectInterface == null
		|| aRectangleObjectInterface.getReachabilityRectangle() == null) {
	    throw new RuntimeException(
		    msg
			    + "RectangleObjectInterface or its getReachabilityRectangle should never be null.");
	}

	return this.myReachabilityRectangle
		.intersects(aRectangleObjectInterface
			.getReachabilityRectangle());
    }
