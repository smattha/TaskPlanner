...
public interface RectangleObjectInterface extends Cloneable, Serializable {
     ...
     * @return
     */
    public abstract boolean isWithinReach(
    ...
    /**
     * set the id of the object that this {@link RectangleObjectInterface}
     * refers to.
     * 
     ...
     * internaly but during the check whether something is reachable or not it
     * is tested as integer
     * 
     * @param reachability
     */
