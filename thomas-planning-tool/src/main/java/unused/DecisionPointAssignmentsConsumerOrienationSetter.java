 ...
 */
public class DecisionPointAssignmentsConsumerOrienationSetter implements
     ...
     */
    public Vector<AssignmentDataModel> consumeDecisionPointAssignments(
...
//	    }
	    ...
	    AssignmentDataModel assignment = new AssignmentDataModel(
		    ...
		    timeNow,
		    helper.getSetUpTimeInMillisecondsForTaskOnResource(
			    taskSimulator, resourceSimulator, timeNow,
			    decisionPointAssignments)
			    + helper.getOperationTimeInMillisecondsForTaskOnResource(
				    taskSimulator, resourceSimulator, timeNow,
				    decisionPointAssignments)
			    + helper.getResourceDownTimeInMillisecondsForTaskOnResource(
				    taskSimulator, resourceSimulator, timeNow,
				    decisionPointAssignments), false, null);
	...
	logger.trace(msg + "decisionPointAssignements.size():"
		+ decisionPointAssignments.size());
