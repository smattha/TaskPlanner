...
public class SchedulingCost3D extends AbstractCriterion {
	...
	public SchedulingCost3D(int internalDH, int internalMNA, int internalSR, PLANNINGINPUT aPlanninginput,
			Document plannignInputDocument) {
		super();
	...
	public double getValue(Vector<TreeNode[]> paths, PlanHelperInterface helper, Calendar timeNow) {
		...
		logger.trace(
				msg + SchedulingCost3D.CRITERION_NAME + "=" + resultCost + ". Solution found=" + totalFoundPlacement);
		return resultCost;
