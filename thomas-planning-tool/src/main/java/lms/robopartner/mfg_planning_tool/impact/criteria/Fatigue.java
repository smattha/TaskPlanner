...
/**
 * Evaluates the Fatigue of the operator in executing a specific task based on the equations in the job rotation paper of LMS.
 * 
...
//                          double distance = Math.sqrt(Math.pow((centerXResource-centerXTask), 2)+Math.pow((centerYResource-centerYTask), 2)+Math.pow((zResource-zTask), 2));
                        ...
                        ///////////////////////////////////////////////////////////IF CORRECT SPEED ///////////////////////////////////////////////////////////////////
                        //double timeToCompleteMovement = distance/(Double.parseDouble(assignment.getResource().getResourceDataModel().getProperty("Speed (mm/s)"))/1000);
                        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        
                        double Fatigue = 0.5*Math.exp(2*(Double.parseDouble(assignment.getTask().getTaskDataModel().getProperty("Weight (Kg)"))*9.81*timeToCompleteMovement/300));
                        
                        double maxFatigue = 0.5*Math.exp(2*(Double.parseDouble(assignment.getResource().getResourceDataModel().getProperty("Payload (kg)"))*9.81*timeToCompleteMovement/300));
                    ...
                    logger.trace(msg + " taskId=" + taskId + " resourceId=" + resourceId + Fatigue.CRITERION_NAME + "=" + partialFatigue);
                }
