 ...
 * In this class, the robot's and human's costs where just taken fromt he user input
 * @author Jason
 *
 */
...
//                        partialAreaCost = Double.MAX_VALUE;
                      logger.debug(msg+"Missing Task Or Resource");
                        ...
                        double InvestmentCost = Double.parseDouble(assignment.getResource().getResourceDataModel().getProperty("Cost (euro)"));
                     //   partialInvestmentCostTemp = ((DemoPlanningGenerator.MAX_INVESTMENT_COST-InvestmentCost)/(DemoPlanningGenerator.MAX_INVESTMENT_COST-DemoPlanningGenerator.MIN_INVESTMENT_COST));       
                        
                    }
                    partialInvestmentCost += partialInvestmentCostTemp;

                    logger.trace(msg + " taskId=" + taskId + " resourceId=" + resourceId +  InvestmentCostold.CRITERION_NAME + "=" + partialInvestmentCost);
                }
