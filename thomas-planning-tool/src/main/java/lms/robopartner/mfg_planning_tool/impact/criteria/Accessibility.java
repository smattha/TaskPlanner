...
public class Accessibility extends AbstractCriterion {
	...
	public double getValue(Vector<TreeNode[]> paths, PlanHelperInterface helper, Calendar timeNow) {
		...
		for ( AssignmentDataModel anAssignment : helper.getAssignments() ) {
			...
			Shape taskRectangle = DataModelToAWTHelper.createShape(taskDataModel.getProperty(MapToResourcesAndTasks.SHAPE_TYPE_NAME), taskDataModel, resourceDataModel);
			...
			if ( !angle.equals("180") && !angle.equals("360") && !angle.equals("0") )
				taskRectangle = DataModelToAWTHelper.rotateShape(Integer.parseInt(angle), taskRectangle, resourcePoint.x, resourcePoint.y, taskDataModel.getProperty(MapToResourcesAndTasks.SHAPE_TYPE_NAME));
		...
		for ( TreeNode[] path : paths ) {
			...
			for ( TreeNode treeNode : path ) {
				...
				for ( Assignment assignment : layerNode.getNodeAssignments() ) {
					...
					if ( taskDataModel.getProperty(MapToResourcesAndTasks.TYPE_PROPERTY_NAME).equals(MapToResourcesAndTasks.TYPE_PROPERTY_VALUE_HUMAN) ) humanResourceRectangle = DataModelToAWTHelper.createRectangle(resourceDataModel, taskDataModel);
					else {
						Shape unassignedTaskRectangle = DataModelToAWTHelper.createShape(taskDataModel.getProperty(MapToResourcesAndTasks.SHAPE_TYPE_NAME), taskDataModel, resourceDataModel);
						String angle = resourceDataModel.getProperty(MapToResourcesAndTasks.ROTATION_Z_PROPERTY_NAME);
						Point resourcePoint = DataModelToAWTHelper.getPointFromResource(resourceDataModel);
						if ( !angle.equals("180") && !angle.equals("360") && !angle.equals("0") )
							unassignedTaskRectangle = DataModelToAWTHelper.rotateShape(Integer.parseInt(angle), unassignedTaskRectangle, resourcePoint.x, resourcePoint.y, taskDataModel.getProperty(MapToResourcesAndTasks.SHAPE_TYPE_NAME));
				...
				for ( Entry<String, Shape> checkinEntry : tasksToAssign.entrySet() ) {
					...
					for ( Entry<String, Shape> checkingWithEntry : tasksToAssign.entrySet() ) {
						...
						if ( checkingRectangle.getBounds().x > checkingWithRectangle.getBounds().x
							...
							if ( (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width) < checkingRectangle.getBounds().x
									&& (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height < checkingRectangle.getBounds().y) ) accessibilitySum += (humanResourceRectangle.width < (checkingRectangle.getBounds().x - (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width))) ? 1
									: 0;
							else if ( (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width) >= checkingRectangle.getBounds().x )
								accessibilitySum += (humanResourceRectangle.height < (checkingRectangle.getBounds().y - (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height))) ? 1
										: 0;
						}
						else if ( checkingRectangle.getBounds().x > checkingWithRectangle.getBounds().x
								&& checkingRectangle.getBounds().y <= checkingWithRectangle.getBounds().y ) {
							if ( checkingRectangle.getBounds().y >= (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height) ) accessibilitySum += (humanResourceRectangle.width < (checkingRectangle.getBounds().x - (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width))) ? 1
									: 0;
							else if ( checkingRectangle.getBounds().y < (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height) )
								accessibilitySum += (humanResourceRectangle.height < (-checkingRectangle.getBounds().y + (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height))) ? 1
										: 0;
						}
						else if ( checkingRectangle.getBounds().x <= checkingWithRectangle.getBounds().x
								&& checkingRectangle.getBounds().y > checkingWithRectangle.getBounds().y ) {
							if ( checkingRectangle.getBounds().x + checkingRectangle.getBounds().height > checkingWithRectangle.getBounds().x ) accessibilitySum += (humanResourceRectangle.width < (-checkingRectangle.getBounds().x + (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width))) ? 1
									: 0;
							else if ( checkingRectangle.getBounds().x + checkingRectangle.getBounds().height <= checkingWithRectangle.getBounds().x )
								accessibilitySum += (humanResourceRectangle.height < (checkingRectangle.getBounds().y - (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height))) ? 1
										: 0;
						}
						else if ( checkingRectangle.getBounds().x <= checkingWithRectangle.getBounds().x
								&& checkingRectangle.getBounds().y <= checkingWithRectangle.getBounds().y ) {
							if ( checkingRectangle.getBounds().y + checkingRectangle.getBounds().width > checkingWithRectangle.getBounds().y ) accessibilitySum += (humanResourceRectangle.width < (-checkingRectangle.getBounds().x + (checkingWithRectangle.getBounds().x + checkingWithRectangle.getBounds().width))) ? 1
									: 0;
							else if ( checkingRectangle.getBounds().y + checkingRectangle.getBounds().width <= checkingWithRectangle.getBounds().y )
								accessibilitySum += (humanResourceRectangle.height < (-checkingRectangle.getBounds().y + (checkingWithRectangle.getBounds().y + checkingWithRectangle.getBounds().height))) ? 1
										: 0;
						}
					}
			...
			else accessibilitySum = paths.size();
		}
