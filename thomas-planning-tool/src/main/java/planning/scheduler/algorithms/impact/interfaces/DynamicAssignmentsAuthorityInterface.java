...
/**
 * Interface to be used for dynamically drop infeasible assignments. USAGE: //
 * Make the vector with all the authorities
 * Vector<DynamicAssignmentsAuthorityInterface> dynamicAssignmentsAuthorities =
 * new Vector<DynamicAssignmentsAuthorityInterface>(); // Add the implementors
...
public interface DynamicAssignmentsAuthorityInterface {
	public abstract boolean areAssignmentsValid(Vector<AssignmentDataModel> currentAssignemnts, Calendar timeNow,
