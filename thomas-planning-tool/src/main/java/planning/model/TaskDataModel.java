...
public class TaskDataModel extends AbstractDataModel {
    ...
    public TaskDataModel(String taskId, String taskName, String description/*, Calendar arrivalDate, Calendar dueDate*/, HashMap<String, String> properties) {
        this.taskId = taskId;
    ...
    /*
     * TODO : Must make sure that the values do not change after the start of the schedule ... by mistake ... maybe protected ???
     */
