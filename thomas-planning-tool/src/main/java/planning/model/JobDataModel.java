...
public class JobDataModel extends AbstractDataModel {
	...
	public JobDataModel(String jobId, String name, String description, Calendar arrivalDate, Calendar dueDate,
			Vector<TaskDataModel> tasks, WorkcenterDataModel workcenter) {
		this.jobId = jobId;
