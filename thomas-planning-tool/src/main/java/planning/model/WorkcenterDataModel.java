...
public class WorkcenterDataModel extends AbstractDataModel {
    ...
    public WorkcenterDataModel(String workcenterId, String name, String description, String algorithm, Vector<ResourceDataModel> resources, InventoryDataModel inventoryDataModel, Vector<DockingStationDataModel> dockingStations) {
