...
//    }
//    
    public AssignmentDataModel(TaskDataModel task, ResourceDataModel resource, Calendar timeOfDispatch, long durationInMilliseconds, boolean locked, HashMap<String, String> properties)
    {
