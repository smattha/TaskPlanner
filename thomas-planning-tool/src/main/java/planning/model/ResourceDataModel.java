...
public class ResourceDataModel extends AbstractDataModel {
	...
	public ResourceDataModel(String resourceId, String resourceName, String description,
			ResourceAvailabilityDataModel resourceAvailability, SetUpMatrixDataModel setUpMatrixDataModel,
			InventoryDataModel endEffectorsDataModel, HashMap<String, String> properties) {
