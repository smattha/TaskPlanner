 ...
 * to a <code>java.net.URLConnection</code> for POSTing. This is primarily for
...
public class MultiPartFormOutputStream {
	 ...
	 * specified output stream and boundary. The boundary is required to be created
	 * before using this method, as described in the description for the
	 * <code>getContentType(String)</code> method. The boundary is only checked for
	 ...
	 * directory, a <code>java.lang.IllegalArgumentException</code> will be thrown.
	 *
	...
	/**
	 * Writes the given bytes. The bytes are assumed to be the contents of a file,
	 * and will be sent as such. If the data is null, a
	 * <code>java.lang.IllegalArgumentException</code> will be thrown.
	 *
	 * @param name     the field name
	 * @param mimeType the file content type (optional, recommended)
	 ...
	 * <code>defaultUseCaches</code> fields to the appropriate settings in the
	 * correct order.
	 *
	...
	/**
	 * Creates a multipart boundary string by concatenating 20 hyphens (-) and the
	 * hexadecimal (base-16) representation of the current time in milliseconds.
	 *
	 ...
	 * connection is acquired, it's too late to set the content type (or any other
	 * request parameter). So one has to create a multipart boundary string first
	 * before using this class, such as with the <code>createBoundary()</code>
	 * method.
	 *
