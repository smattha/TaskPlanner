...
public abstract class AbstractOutputSource {
	...
	public abstract void savePlanningInputXMLDocument(Node planningInputXMLDocument)
			throws MalformedURLException, IOException, ParserConfigurationException, SAXException;

	public abstract void savePlanningOutputXMLDocument(Document planningOutputXMLDocument)
			throws MalformedURLException, IOException, ParserConfigurationException, SAXException;
}