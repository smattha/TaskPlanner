...
public class FileInputSource extends AbstractInputSource
{
    ...
    public Document fetchPlanningOutputXMLDocument() throws java.net.MalformedURLException, java.io.IOException, javax.xml.parsers.ParserConfigurationException, org.xml.sax.SAXException
    {
    ...
    public Document fetchPlanningInputXMLDocument() throws java.net.MalformedURLException, java.io.IOException, javax.xml.parsers.ParserConfigurationException, org.xml.sax.SAXException
    {
