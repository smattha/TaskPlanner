...
public class TaskSuitableResourceDataModel extends AbstractDataModel {
    ...
    public TaskSuitableResourceDataModel(TaskDataModel task, ResourceDataModel resource, long operationTimeInMilliseconds, String setupCode, HashMap<String, String> properties) {
        this.task = task;
    ...
    public Node toXMLNode(Document document) {
        ...
        operationTimePerBatchInSecondsElement.appendChild(document.createTextNode("" + (this.operationTimeInMilliseconds / 1000)));
