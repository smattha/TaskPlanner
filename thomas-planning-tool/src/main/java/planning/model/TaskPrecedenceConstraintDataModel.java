...
public class TaskPrecedenceConstraintDataModel extends AbstractDataModel {
    ...
    public TaskPrecedenceConstraintDataModel(TaskDataModel preconditionTask, TaskDataModel postconditionTask, Boolean isConstraintTypeNextTaskInChain, Boolean isResourceUnavailableBetweenTasks) {
